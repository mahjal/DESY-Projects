...
namespace Rivet {
  ...
  public:
    ...
    /// Constructor
    RIVET_DEFAULT_ANALYSIS_CTOR(mytest);
    ...
    void init() {
      ...
      book(_h["YYYY"], "myh2", logspace(20, 1e-2, 1e2));
      book(_h["ZZZZ"], "myh3", {0.0, 10.0, 20.0, 40.0, 80.0, 1600.0});
      // take binning from reference data using HEPData ID (digits in "d01-x01-y01" etc.)
      //      book(_h["AAAA"], 1, 1, 1);
      //      book(_p["BBBB"], 2, 1, 1);
      //      book(_c["CCCC"], 3, 1, 1);

      //      cout << "Here in init" << endl;
